...
clean_data <- function(df) {
  ...
  df <- df %>%
    ...
    mutate(
      ...
      topic_title_short =
             case_when(
               topic_title == "Abwasserreinigungsanlagen (ARA) mit Finanzkennzahlen" ~ "ARAF",
               topic_title == "Abwasserreinigungsanlagen (ARA) ohne Finanzkennzahlen" ~ "ARA",
               ...
               topic_title == "Kommunale Entwässerungsplanung (GEP) ohne Finanzkennzahlen" ~ "GEP",
